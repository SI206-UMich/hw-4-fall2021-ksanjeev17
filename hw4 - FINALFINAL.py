...
class TestAllMethods(unittest.TestCase):
    ...
    def test_has_item(self):
        ...
        self.assertFalse(self.s1.has_item("Noodle",1))
        # Test case 2: the stall does not have enough food item: 
        self.assertFalse(self.s1.has_item("Burger",50))
        # Test case 3: the stall has the food item of the certain quantity: 
        self.assertTrue(self.s1.has_item("Burger",28))
    ...
    def test_validate_order(self):
        ...
        self.assertFalse(self.f1.validate_order(self.c3, self.s1, "Burger", 1))
        # case 4: successful order (should not output anything)
        self.f1.validate_order(self.c1, self.s1, "Burger", 8)

    # Test if a customer can add money to their wallet
    def test_reload_money(self):
        self.f3 = Customer("Wah")
        self.f3.reload_money(50)
        self.assertEqual(self.f3.wallet, 150)
    
# Write main function
def main():
    # Create different objects 
    menu1 = {"noodles": 20, "dumplings": 10}
    menu2 = {"burger": 10, "fries": 5}
    ...
    cash1 = Cashier("Alex", [s2])
    cash2 = Cashier("Zack", [s1])
    # Try all cases in the validate_order function
    # Below you need to have *each customer instance* try the four cases
    # case 1: the cashier does not have the stall 
    cust1.validate_order(cash1, s1, "noodles", 5)
    cust2.validate_order(cash2, s2, "burger", 10)
    # case 2: the casher has the stall, but not enough ordered food or the ordered food item
    cust1.validate_order(cash1, s2, "burger", 15)
    cust2.validate_order(cash2, s1, "dumplings", 11)
    # case 3: the customer does not have enough money to pay for the order: 
    cust1.validate_order(cash1, s2, "burger", 2)
    cust2.validate_order(cash2, s1, "dumplings", 2)
    # case 4: the customer successfully places an order
    cust1.validate_order(cash1, s2, "burger", 1)
    cust2.validate_order(cash2, s1, "dumplings", 1)
